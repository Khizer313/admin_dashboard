...
import './sevenChartBox.scss'
import { AreaChart, Tooltip, ResponsiveContainer,  XAxis, YAxis, Area } from "recharts";

// -------------- simpleAreaChart of AreaChart from rechart.com --------------------------
const data = [
    {
      name: 'Sun',
      books: 4000,
